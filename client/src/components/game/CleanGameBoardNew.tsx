  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <div className="lg:col-span-2 flex-1">
        ...
        <div className="bg-gradient-to-b from-green-600 to-green-700 rounded-2xl shadow-2xl border-8 border-yellow-600 p-8 mb-6 relative">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-2 sm:gap-3 mb-6 overflow-x-auto">
              {[28, 21, 105, 500, 99, 20, 82, 3].map((num, index) => (
                <div
                  key={num}
                  className={`
                    w-14 h-16 sm:w-16 sm:h-20 rounded-2xl flex items-center justify-center 
                    text-sm sm:text-lg font-bold shadow-lg flex-shrink-0
            ...
            <div className="flex justify-center mt-8">
              <Button
                ...
                className="
                  ...
                  text-black font-bold text-lg sm:text-xl px-8 sm:px-12 py-6 sm:py-4 
                  ...
                  min-h-[60px] sm:min-h-[auto] w-full max-w-xs sm:w-auto
                "
                size="lg"
              >
                {isRolling ? (
      ...
      <div className="lg:w-80 space-y-6">
        {/* Voice Chat for higher stakes */}
        {game.stake >= 20000 && (
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4 border border-purple-200">
            <h3 className="text-lg font-bold text-purple-800 mb-4">🎤 Voice Chat</h3>
            <VoiceChat 
              game={game}
              players={players}
      ...
      {/* Bot Personality Controls - Only show for bot games */}
      {players.some(p => p.user.username === 'Computer') && (
        <div className="fixed bottom-6 left-6 bg-white rounded-lg shadow-lg p-4 space-y-3 z-40 border">
